...
ActiveRecord::Schema.define(version: 20150328002048) do
  ...
  add_index "omni_auth_providers", ["subscriber_type", "subscriber_id"], name: "index_omni_auth_providers_on_subscriber_type_and_subscriber_id", using: :btree
